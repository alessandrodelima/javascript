...
//document.body.innerHTML += `A segunda letra do seu nome é:${nome.charAt(1)} <br />`; ou 
...
/*
document.body.innerHTML = "Um texto qualquer";
document.body.innerHTML = "Outra coisa qualquer ";
document.body.innerHTML += 'Escrever <br />';
document.body.innerHTML += 'um texto <br />';
document.body.innerHTML += 'um texto';
*/